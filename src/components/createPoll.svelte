<script>
    ...
    function createPollHandler() {
        poll = {id:  Math.floor(Math.random()*100), q: pollQuestion, optionA, optionB, voteA, voteB};
        dispatch('addpoll', poll);
        dispatch('changeTab', 'Show Polls');
    }
...
<main>
    <div class="create-poll">
        <h3>Create Poll</h3>
        <div class="qna-grid">
            <span style="color: #222;">Question: </span> <input type="text" bind:value={pollQuestion}/>
        </div>
        <div>
            <div class="qna-grid">
